...
andrew_howes = Artist.create(name: "Andrew Hoves")
andrew_howes.photo.attach(io: File.open("#{tmp_dir}/seed_files/andrew_howes.jpg"), filename: "andrew_howes.jpg")

gubernator = andrew_howes.albums.create(title: "Gubernator", date:
Time.strptime("18/05/2015", "%d/%m/%Y"), category: rock)
...
the_great_bear = andrew_howes.albums.create(title: "The Great Bear", date:
Time.strptime("19/05/2015", "%d/%m/%Y"), category: rock)
...
four_am = the_great_bear.songs.create(title: "Four am", played_count: Random.rand(1000))
...
barcelona = yellow_chair.albums.create(title: "Barcelona", date:
Time.strptime("18/05/2015", "%d/%m/%Y"), category: rock)
barcelona.cover.attach(io: File.open("#{tmp_dir}/seed_files/barcelona.jpg"), filename: "barcelona.jpg")

via_laietana = barcelona.songs.create(title: "Dumb Luck", played_count: Random.rand(1000))
via_laietana.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/via_laietana.mp3"), filename: "via_laietana.mp3")

passeig_de_gracia = barcelona.songs.create(title: "Passeig de Gracia", played_count: Random.rand(1000))
...
everything_zen = yellow_chair.albums.create(title: "Everything Zen", date:
Time.strptime("19/05/2015", "%d/%m/%Y"), category: rock)
everything_zen.cover.attach(io: File.open("#{tmp_dir}/seed_files/everything_zen.jpg"), filename: "everything_zen.jpg")

everything_zen_music = everything_zen.songs.create(title: "Big Drop", played_count: Random.rand(1000))
everything_zen_music.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/everything_zen.mp3"), filename: "everything_zen.mp3")

meng_jia = yellow_chair.albums.create(title: "Meng Jia", date:
Time.strptime("07/03/2014", "%d/%m/%Y"), category: rock)
...
coronation_pope_francis = meng_jia.songs.create(title: "Coronation Pope Francis", played_count: Random.rand(1000))
...
waylon_thornton = Artist.create(name: "Yellow Chair")
waylon_thornton.photo.attach(io: File.open("#{tmp_dir}/seed_files/waylon_thornton.jpg"), filename: "waylon_thornton.jpg")

mystery_club = waylon_thornton.albums.create(title: "Barcelona", date:
Time.strptime("18/05/2015", "%d/%m/%Y"), category: rock)
...
very_hazel = mystery_club.songs.create(title: "Passeig de Gracia", played_count: Random.rand(1000))
very_hazel.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/very_hazel.mp3"), filename: "very_hazel.mp3")

favorite_secrets = mystery_club.songs.create(title: "Itaca", played_count: Random.rand(1000))
...
covers_besides = break_the_bans.albums.create(title: "Barcelona", date:
Time.strptime("29/07/2013", "%d/%m/%Y"), category: blues)
covers_besides.cover.attach(io: File.open("#{tmp_dir}/seed_files/covers_besides.jpg"), filename: "covers_besides.jpg")

how_can_i_love_her = covers_besides.songs.create(title: "Wobbly Way", played_count: Random.rand(1000))
...
be_love_not_fear = cullah.albums.create(title: "Barcelona", date:
Time.strptime("29/07/2013", "%d/%m/%Y"), category: blues)
...
trinity = cullah.albums.create(title: "Barcelona", date:
Time.strptime("24/07/2016", "%d/%m/%Y"), category: blues)
trinity.cover.attach(io: File.open("#{tmp_dir}/seed_files/trinity.jpg"), filename: "trinity.jpg")

freed_from_greed = be_love_not_fear.songs.create(title: "Freed From Greed", played_count: Random.rand(1000))
freed_from_greed.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/freed_from_greed.mp3"), filename: "freed_from_greed.mp3")

aisling = be_love_not_fear.songs.create(title: "Aisling", played_count: Random.rand(1000))
...
paw_paw_tree = handmade_moments.albums.create(title: "Paw Paw Tree", date:
Time.strptime("29/07/2013", "%d/%m/%Y"), category: country)
...
wanderin_eyes = paw_paw_tree.songs.create(title: "Wandering Eyes", played_count: Random.rand(1000))
...
years_and_years_ago = dee_yan_key.albums.create(title: "Years and Years malvinas_go_go", date:
Time.strptime("29/07/2011", "%d/%m/%Y"), category: country)
...
clowns = years_and_years_ago.songs.create(title: "Clouns", played_count: Random.rand(1000))
clowns.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/clowns.mp3"), filename: "clowns.mp3")

coffee_chocolate_earth = years_and_years_ago.songs.create(title: "Coffee Chocolate Earth", played_count: Random.rand(1000))
coffee_chocolate_earth.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/coffee_chocolate_earth.mp3"), filename: "coffee_chocolate_earth.mp3")

mans_life = dee_yan_key.albums.create(title: "A Man's Life", date:
Time.strptime("29/07/2012", "%d/%m/%Y"), category: jazz)
...
aldebaran = dee_yan_key.albums.create(title: "Aldebaran", date:
Time.strptime("30/01/2012", "%d/%m/%Y"), category: jazz)
...
inside = king_imagine.albums.create(title: "Inside", date:
Time.strptime("29/07/2013", "%d/%m/%Y"), category: country)
...
freddie_mercury = User.create(name: "Frerddie Mercury", email: "freddie@mercury.com",
...
diana_ross = User.create(name: "Diana Ross", email: "diana@ross.com",
password: "123456", password_confirmation: "123456")
...
celine_dion = User.create(name: "Celine Dion", email: "celine@dion.com",
password: "123456", password_confirmation: "123456")
